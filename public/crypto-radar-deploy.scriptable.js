 ...
 * 一年沒動過的多半已經沒在維護。
 */
async function listScriptsDetailed(client, accountId) {
...
function describeAge(iso, now = Date.now()) {
  if (!iso) return null;
 ...
 * 不讓單一支失敗擋掉整份盤點。
 */
async function auditCrons(client, accountId, now = Date.now()) {
...
const GUARDIAN_SCRIPT = "const $e=Object.freeze([\"live\",\"demo\",\"testnet\"]),Q=Object.freeze({live:\"\\u6B63\\u5F0F\\u7AD9\",demo:\"\\u6A21\\u64EC\\u4EA4\\u6613 Demo\",testnet:\"\\u6E2C\\u8A66\\u7DB2 Testnet\"}),ke=Object.freeze({live:\"https://api.bybit.com\",demo:\"https://api-demo.bybit.com\",testnet:\"https://api-testnet.bybit.com\"}),ee=Object.freeze({live:\"https://api.bybit.com\",demo:\"https://api.bybit.com\",testnet:\"https://api-testnet.byb\\\nit.com\"}),te=ee.live;function _(e){return $e.includes(e)?e:\"live\"}function Ae(e){return ke[_(e)]}function Ce(e){return ee[_(e)]}function U(e){return String(e??\"\").replace(/[\\s\\u00A0\\u200B-\\u200D\\u2060\\uFEFF]/g,\"\")}function ne(e,t,s){const n=Number(e),i=Q[_(s)],r=t?`\\uFF08${t}\\uFF09`:\"\";return n===10003?`\\u76EE\\u524D\\u9023\\u7684\\u662F\\u300C${i}\\u300D\\uFF0C\\u4F46\\u9019\\u500B\\u74B0\\u5883\\u4E0D\\u8A8D\\u5F97\\u9019\\u628A API Key${r}\\\n\\u3002\n\n\\u6700\\u5E38\\u898B\\u7684\\u539F\\u56E0\\u662F\\u74B0\\u5883\\u9078\\u932F\\uFF1A\\u6A21\\u64EC\\u4EA4\\u6613\\u8207\\u6E2C\\u8A66\\u7DB2\\u5404\\u81EA\\u767C\\u81EA\\u5DF1\\u7684 Key\\uFF0C\\u4E0D\\u80FD\\u62FF\\u53BB\\u6253\\u6B63\\u5F0F\\u7AD9\\u3002\n\\u8ACB\\u78BA\\u8A8D\\u4F60\\u7684 Key \\u662F\\u5728\\u54EA\\u88E1\\u5EFA\\u7ACB\\u7684\\uFF0C\\u56DE\\u8A2D\\u5B9A\\u9078\\u55AE\\u6539\\u9078\\u5C0D\\u61C9\\u7684\\u74B0\\u5883\\u3002\n\\u82E5\\u74B0\\u5883\\u6C92\\u9078\\u932F\\uFF0C\\u8ACB\\u6AA2\\u67E5 Key \\u662F\\u5426\\u6709\\u591A\\u6253\\u6216\\u6F0F\\u6253\\u5B57\\u5143\\u3001\\u662F\\u5426\\u5DF2\\u88AB\\u522A\\u9664\\u6216\\u904E\\u671F\\u3002`:n===10004?`\\u7C3D\\u7AE0\\u9A57\\u8B49\\u5931\\u6557${r}\\u3002\\u8ACB\\u78BA\\u8A8D API Secret \\u6709\\u6C92\\u6709\\u8CBC\\u932F\\u6216\\u8CBC\\u4E0D\\u5B8C\\u6574\\u3002`:n===10002?`\\u6642\\u9593\\u6233\\u8D85\\u51FA\\u5BB9\\u8A31\\u7BC4\\u570D${r}\\\n\\u3002\\u8ACB\\u5230 iPhone \\u8A2D\\u5B9A \\u2192 \\u4E00\\u822C \\u2192 \\u65E5\\u671F\\u8207\\u6642\\u9593\\uFF0C\\u958B\\u555F\\u300C\\u81EA\\u52D5\\u8A2D\\u5B9A\\u300D\\u3002`:n===10005||n===10016?`\\u9019\\u628A Key \\u6C92\\u6709\\u8B80\\u53D6\\u6B0A\\u9650${r}\\u3002\\u8ACB\\u5728 Bybit \\u7D66\\u5B83\\u300C\\u5E33\\u6236\\u67E5\\u8A62\\u300D\\u8207\\u300C\\u6301\\u5009\\u67E5\\u8A62\\u300D\\u7684\\u552F\\u8B80\\u6B0A\\u9650\\u3002`:n===10010?\n`\\u9019\\u628A Key \\u8A2D\\u4E86 IP \\u767D\\u540D\\u55AE\\uFF0C\\u4F46\\u76EE\\u524D\\u7684\\u7DB2\\u8DEF\\u4E0D\\u5728\\u540D\\u55AE\\u5167${r}\\u3002\n\\u624B\\u6A5F\\u7684 IP \\u6703\\u8B8A\\u52D5\\uFF0C\\u5EFA\\u8B70\\u6539\\u7528\\u4E0D\\u7D81 IP \\u7684\\u552F\\u8B80 Key\\uFF0C\\u6216\\u628A\\u76EE\\u524D IP \\u52A0\\u9032\\u767D\\u540D\\u55AE\\u3002`:n===10018?`\\u8ACB\\u6C42\\u983B\\u7387\\u904E\\u9AD8${r}\\u3002\\u8ACB\\u7A0D\\u7B49\\u4E00\\u4E0B\\u518D\\u8A66\\u3002`:n===30086||n===3400026?`\\u5E33\\u6236\\u985E\\u578B\\u4E0D\\u7B26${r}\\u3002\\u9019\\u500B\\u67E5\\u8A62\\u9700\\u8981\\u7D71\\u4E00\\u5E33\\u6236\\uFF08Unified Trading Account\\uFF09\\u3002`:\n`Bybit retCode ${e}${r}`}function j(e){return Number.isFinite(e)?e>=1e3?1:e>=10?3:e>=1?4:e>=.01?5:7:4}const b=(e,t)=>Number.isFinite(e)?e.toFixed(t??4):\"\\u2014\",D=e=>Number.isFinite(e)?(e>=0?\"+\":\"\")+e.toFixed(2)+\"%\":\"\\u2014\",L=e=>Number.isFinite(e)?(e>=0?\"\":\"-\")+Math.abs(e).toFixed(2):\"\\u2014\";function X(e){return!Number.isFinite(e)||e<=0?\"\\u2014\":e>=1e9?(e/1e9).toFixed(2)+\"B\":e>=1e6?(e/1e6).toFixed(\n2)+\"M\":e>=1e3?(e/1e3).toFixed(1)+\"K\":e.toFixed(0)}const F=e=>Number.isFinite(e)?e>=0?\"pos\":\"neg\":\"\";function Ee(e,t){if(!e)return\"\\u5C1A\\u672A\\u6383\\u63CF\";const s=Math.max(0,Math.round(((t??Date.now())-e)/1e3));return s<60?s+\" \\u79D2\\u524D\":Math.round(s/60)+\" \\u5206\\u9418\\u524D\"}const Te=new Uint32Array([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,\n310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,\n275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]),$=(e,t)=>(e>>>t|e<<32-t)>>>0;function Y(e){const t=new Uint32Array([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]),s=e.length*8,n=new Uint8Array((e.length+8>>6)+1<<6);n.set(e),\nn[e.length]=128;const i=Math.floor(s/4294967296),r=s>>>0,a=new DataView(n.buffer);a.setUint32(n.length-8,i,!1),a.setUint32(n.length-4,r,!1);const o=new Uint32Array(64);for(let u=0;u<n.length;u+=64){for(let m=0;m<16;m+=1)o[m]=a.getUint32(u+m*4,!1);for(let m=16;m<64;m+=1){const M=($(o[m-15],7)^$(o[m-15],18)^o[m-15]>>>3)>>>0,O=($(o[m-2],17)^$(o[m-2],19)^o[m-2]>>>10)>>>0;o[m]=o[m-16]+M+o[m-7]+O>>>0}let[\nl,f,p,h,P,w,S,R]=t;for(let m=0;m<64;m+=1){const M=($(P,6)^$(P,11)^$(P,25))>>>0,O=(P&w^~P&S)>>>0,B=R+M+O+Te[m]+o[m]>>>0,W=($(l,2)^$(l,13)^$(l,22))>>>0,v=(l&f^l&p^f&p)>>>0,K=W+v>>>0;R=S,S=w,w=P,P=h+B>>>0,h=p,p=f,f=l,l=B+K>>>0}t[0]=t[0]+l>>>0,t[1]=t[1]+f>>>0,t[2]=t[2]+p>>>0,t[3]=t[3]+h>>>0,t[4]=t[4]+P>>>0,t[5]=t[5]+w>>>0,t[6]=t[6]+S>>>0,t[7]=t[7]+R>>>0}const c=new Uint8Array(32),d=new DataView(c.buffer);\nfor(let u=0;u<8;u+=1)d.setUint32(u*4,t[u],!1);return c}function se(e){const t=String(e),s=[];for(let n=0;n<t.length;n+=1){let i=t.charCodeAt(n);if(i>=55296&&i<=56319&&n+1<t.length){const r=t.charCodeAt(n+1);r>=56320&&r<=57343&&(i=65536+(i-55296<<10)+(r-56320),n+=1)}i<128?s.push(i):i<2048?s.push(192|i>>6,128|i&63):i<65536?s.push(224|i>>12,128|i>>6&63,128|i&63):s.push(240|i>>18,128|i>>12&63,128|i>>6&\n63,128|i&63)}return new Uint8Array(s)}function Re(e){let t=\"\";for(let s=0;s<e.length;s+=1)t+=e[s].toString(16).padStart(2,\"0\");return t}function zt(e){const t=String(e).trim(),s=new Uint8Array(t.length/2);for(let n=0;n<s.length;n+=1)s[n]=parseInt(t.substr(n*2,2),16);return s}const E=64;function Ue(e,t){let s=typeof e==\"string\"?se(e):e;const n=typeof t==\"string\"?se(t):t;s.length>E&&(s=Y(s));const i=new Uint8Array(\nE);i.set(s);const r=new Uint8Array(E+n.length),a=new Uint8Array(E);for(let d=0;d<E;d+=1)r[d]=i[d]^54,a[d]=i[d]^92;r.set(n,E);const o=Y(r),c=new Uint8Array(E+32);return c.set(a),c.set(o,E),Y(c)}function De(e,t){return Re(Ue(e,t))}const Fe=\"5000\",Ie=Object.freeze([\"/v5/account/wallet-balance\",\"/v5/position/list\",\"/v5/position/closed-pnl\",\"/v5/execution/list\",\"/v5/order/realtime\"]),Me=[/\\/order\\/create/i,\n/\\/order\\/amend/i,/\\/order\\/cancel/i,/\\/order\\/disconnected/i,/\\/position\\/set-/i,/\\/position\\/trading-stop/i,/\\/position\\/switch/i,/\\/asset\\/transfer/i,/\\/asset\\/withdraw/i,/\\/account\\/upgrade/i,/\\/account\\/set-/i,/\\/user\\//i];class ie extends Error{constructor(t){super(`\\u7AEF\\u9EDE\\u4E0D\\u5728\\u552F\\u8B80\\u767D\\u540D\\u55AE\\u5167\\uFF0C\\u62D2\\u7D55\\u547C\\u53EB\\uFF1A${t}`),this.name=\"ForbiddenEndp\\\nointError\"}}function Be(e){const t=String(e).split(\"?\")[0];for(const s of Me)if(s.test(t))throw new ie(t);if(!Ie.includes(t))throw new ie(t);return t}function Oe(e){return Object.keys(e??{}).filter(s=>{const n=e[s];return n!=null&&n!==\"\"}).map(s=>`${encodeURIComponent(s)}=${encodeURIComponent(String(e[s]))}`).join(\"&\")}function _e({path:e,params:t,apiKey:s,apiSecret:n,timestamp:i,recvWindow:r,env:a}){\nconst o=Be(e);if(typeof s!=\"string\"||s.length===0)throw new Error(\"\\u7F3A\\u5C11 API Key\");if(typeof n!=\"string\"||n.length===0)throw new Error(\"\\u7F3A\\u5C11 API Secret\");const c=String(i??Date.now()),d=String(r??Fe),u=Oe(t),l=c+s+d+u,f=De(n,l);return{url:(a?Ae(a):te)+o+(u?`?${u}`:\"\"),queryString:u,headers:{\"X-BAPI-API-KEY\":s,\"X-BAPI-TIMESTAMP\":c,\"X-BAPI-RECV-WINDOW\":d,\"X-BAPI-SIGN\":f,\"X-BAPI-SIGN-T\\\nYPE\":\"2\",accept:\"application/json\"}}}const x=e=>{const t=typeof e==\"number\"?e:Number(e);return Number.isFinite(t)?t:NaN};function Le(e){const t=e?.list?.[0];if(!t)return null;const s=(t.coin??[]).find(n=>n.coin===\"USDT\");return{accountType:t.accountType??null,totalEquityUsd:x(t.totalEquity),totalAvailableUsd:x(t.totalAvailableBalance),unrealizedPnlUsd:x(t.totalPerpUPL),usdtEquity:s?x(s.equity):NaN,\nusdtAvailable:s?x(s.availableToWithdraw??s.walletBalance):NaN}}function ze(e){return(e?.list??[]).map(t=>({symbol:t.symbol,side:t.side===\"Buy\"?\"long\":t.side===\"Sell\"?\"short\":null,size:x(t.size),entryPrice:x(t.avgPrice),markPrice:x(t.markPrice),leverage:x(t.leverage),unrealizedPnl:x(t.unrealisedPnl),positionValue:x(t.positionValue),takeProfit:x(t.takeProfit),stopLoss:x(t.stopLoss),liqPrice:x(t.liqPrice)})).\nfilter(t=>Number.isFinite(t.size)&&t.size>0)}function He(e){return(e?.list??[]).map(t=>({symbol:t.symbol,side:t.side===\"Buy\"?\"short\":\"long\",closedPnl:x(t.closedPnl),avgEntryPrice:x(t.avgEntryPrice),avgExitPrice:x(t.avgExitPrice),closedSize:x(t.closedSize),leverage:x(t.leverage),createdTime:x(t.createdTime)}))}function Ke(e){const t=Number.isFinite(e.takeProfit)&&e.takeProfit>0,s=Number.isFinite(e.\nstopLoss)&&e.stopLoss>0;return t&&s?{level:\"ok\",text:\"TP\\uFF0FSL \\u7686\\u5DF2\\u8A2D\\u5B9A\"}:s?{level:\"warn\",text:\"\\u53EA\\u6709 SL\\uFF0C\\u7F3A TP\"}:t?{level:\"danger\",text:\"\\u53EA\\u6709 TP\\uFF0C\\u7F3A SL\"}:{level:\"danger\",text:\"\\u6C92\\u6709 TP \\u4E5F\\u6C92\\u6709 SL\"}}function je(e,t){const s=(e??[]).filter(n=>Number.isFinite(n.createdTime)&&n.createdTime>=t);return s.length?{total:s.reduce((n,i)=>n+\n(Number.isFinite(i.closedPnl)?i.closedPnl:0),0),count:s.length}:{total:0,count:0}}function re(e){const t=String(e??\"\");return t.length<=8?\"\\u2022\\u2022\\u2022\\u2022\":`${t.slice(0,4)}\\u2022\\u2022\\u2022\\u2022${t.slice(-4)}`}const Ve=/^https:\\/\\/(?:\\w+\\.)?discord(?:app)?\\.com\\/api\\/webhooks\\/\\d+\\/[\\w-]+$/;function ae(e){return typeof e==\"string\"&&Ve.test(e.trim())}function Ht(e){if(typeof e!=\"string\"||\n!e)return\"\\u672A\\u8A2D\\u5B9A\";const t=/\\/webhooks\\/(\\d+)\\//.exec(e);return t?`Webhook \\u2022\\u2022\\u2022\\u2022${t[1].slice(-4)}`:\"Webhook \\u2022\\u2022\\u2022\\u2022\"}function Ge(e){const t=j(e.lastPrice),s=e.isMeme?\"\\u8FF7\\u56E0\\u5E63\\uFF0F\\u9AD8\\u98A8\\u96AA\":\"\\u4E3B\\u5E63\",n=[`**${e.symbol}** \\xB7 ${s} \\xB7 \\u5B8C\\u6210\\u5EA6 ${e.score}`,`\\u9032\\u5834\\u689D\\u4EF6 ${e.readiness.passed}/${e.readiness.\ntotal} \\u5DF2\\u901A\\u904E`,\"\",`Entry\\u3000${b(e.entryLow,t)} \\u2013 ${b(e.entryHigh,t)}`,`SL\\u3000\\u3000${b(e.stopLoss,t)}`,`TP1\\u3000 ${b(e.takeProfit1,t)}\\u3000(1.5R)`,`TP2\\u3000 ${b(e.takeProfit2,t)}\\u3000(2.5R)`,\"\",`\\u8DDD\\u7A81\\u7834\\u9EDE ${D(e.breakoutDistancePct)}\\u3000\\u58D3\\u7E2E\\u6BD4 ${b(e.compressionRatio,3)}`,`\\u91CF\\u80FD ${b(e.volumeMultiple,2)}x\\u3000OI ${D(e.oiChangePct)}`];return e.\nriskLabel&&n.push(\"\",`\\u26A0 ${e.riskLabel}`),n.push(\"\",\"\\u5B8C\\u6210\\u5EA6\\u4E0D\\u662F\\u52DD\\u7387\\u3002\\u9019\\u662F\\u6383\\u63CF\\u7D50\\u679C\\uFF0C\\u4E0D\\u662F\\u6295\\u8CC7\\u5EFA\\u8B70\\uFF0C\\u4E5F\\u4E0D\\u6703\\u81EA\\u52D5\\u4E0B\\u55AE\\u3002\"),n.push(e.bybitUrl),n.join(`\n`)}function Kt(e){const t=new Date(e.scannedAt).toISOString().replace(\"T\",\" \").slice(0,16);if(!e.ready.length)return`**Crypto Radar \\u6383\\u63CF\\u5B8C\\u6210** \\xB7 ${t} UTC\n\\u4E3B\\u5E63 ${e.mainCount} \\u6A94\\u3001\\u8FF7\\u56E0\\u5E63 ${e.memeCount} \\u6A94\\u5DF2\\u5206\\u6790\\uFF0C\\u76EE\\u524D\\u6C92\\u6709\\u7B26\\u5408\\u5168\\u90E8\\u9032\\u5834\\u689D\\u4EF6\\u7684\\u5019\\u9078\\u3002`;const s=e.ready.map(n=>`${n.symbol}(${n.score})`).join(\"\\u3001\");return`**Crypto Radar \\u6383\\u63CF\\u5B8C\\u6210** \\xB7 ${t} UTC\n\\u7B26\\u5408\\u5168\\u90E8\\u9032\\u5834\\u689D\\u4EF6\\uFF1A${s}\n\\u5B8C\\u6210\\u5EA6\\u4E0D\\u662F\\u52DD\\u7387\\uFF0C\\u8ACB\\u81EA\\u884C\\u78BA\\u8A8D\\u98A8\\u96AA\\u3002`}function We(e){const t=e.filter(n=>n.protection&&n.protection.level!==\"ok\");if(!t.length)return null;const s=[\"**\\u6301\\u5009\\u4FDD\\u8B77\\u6AA2\\u67E5**\",\"\"];for(const n of t)s.push(`${n.symbol} ${n.side===\"long\"?\"\\u591A\":\"\\u7A7A\"}\\u3000${n.protection.text}`);return s.push(\"\",\"\\u9019\\u662F\\u552F\\u8B80\\u6AA2\\u67E5\\uFF0C\\u672C\\u5DE5\\u5177\\u4E0D\\u6703\\u66FF\\u4F60\\u639B\\u55AE\\u6216\\u5E73\\u5009\\u3002\"),\ns.join(`\n`)}function jt(){return`**Crypto Radar** \\u901A\\u77E5\\u6E2C\\u8A66\\u6210\\u529F\\u3002\n\\u672C\\u5DE5\\u5177\\u53EA\\u8B80\\u53D6 Bybit \\u516C\\u958B\\u884C\\u60C5\\u8207\\u552F\\u8B80\\u5E33\\u6236\\u8CC7\\u6599\\uFF0C\\u4E0D\\u6703\\u4E0B\\u55AE\\u3002`}function Xe(e){return`${e.symbol}:${e.entryReady?\"ready\":\"watch\"}:${e.stage}`}function Ye(e,t,s,n=60){const i={...t?.sent??{}},r=n*6e4,a=[];for(const o of e??[]){const c=Xe(o),d=i[c];(!Number.isFinite(d)||s-d>=r)&&(a.push(o),i[c]=s)}for(const o of Object.\nkeys(i))s-i[o]>864e5&&delete i[o];return{toSend:a,state:{sent:i,lastSentAt:a.length?s:t?.lastSentAt??null}}}const oe=1900;function Je(e){const t=String(e??\"\");return{content:t.length>oe?`${t.slice(0,oe)}\\u2026`:t,allowed_mentions:{parse:[]}}}async function ce(e,t,s){if(!ae(t))return{ok:!1,error:\"Webhook \\u7DB2\\u5740\\u683C\\u5F0F\\u4E0D\\u6B63\\u78BA\"};try{return await e(t,Je(s)),{ok:!0,error:null}}catch(n){\nreturn{ok:!1,error:String(n&&n.message?n.message:n).split(t).join(\"[webhook]\")}}}const le=\"Bybit Pre-Breakout\",qe=\"10.0-standalone\",k=Object.freeze({minTurnover24hUsd:5e5,minOpenInterestUsd:1e5,minListedHours:24,maxListedHours:24*365*3,maxSpreadPct:.6,minChange24hPct:-12,maxChange24hPct:10,minRangePosition:.35,maxRangePosition:.96,maxDetailedAnalysis:12}),N=Object.freeze({maxChange24hPct:10,maxChange1hPct:4,\nmaxChange6hPct:10,maxBreakoutOvershootPct:.8,maxVolumeMultiple:5,maxBreakoutDistancePct:4,maxCompressionRatio:1.2,maxAbsFundingRatePct:.15}),g=Object.freeze({minScore:80,minBreakoutDistancePct:-.25,maxBreakoutDistancePct:2,maxCompressionRatio:.95,minVolumeMultiple:1.1,maxVolumeMultiple:3,minOiChangePct:.25,maxOiChangePct:5,minChange1hPct:-1,maxChange1hPct:2.5,minChange6hPct:-3,maxChange6hPct:6,maxDataAgeMinutes:45,\nstaleWarningMinutes:15}),ue=8,Ze=Object.freeze([\"PEPE\",\"DOGE\",\"SHIB\",\"WIF\",\"BONK\",\"FLOKI\",\"TRUMP\"]),Qe=Object.freeze([\"BTC\",\"ETH\",\"SOL\",\"BNB\",\"XRP\",\"ADA\",\"AVAX\",\"LINK\",\"LTC\",\"DOT\",\"ATOM\",\"ARB\",\"OP\",\"MATIC\",\"TON\",\"TRX\",\"NEAR\",\"APT\",\"SUI\",\"INJ\",\"FIL\",\"ETC\",\"BCH\",\"UNI\",\"AAVE\",\"XLM\",\"ICP\",\"HBAR\",\"VET\",\"ALGO\"]),et=.15,J=Object.freeze([\"BTCUSDT\",\"ETHUSDT\",\"SOLUSDT\"]);function tt(e,t,s){return(s??J).includes(\nString(e).toUpperCase())?\"main\":t?\"meme\":\"main\"}const nt=new Set([\"USDC\",\"USDT\",\"DAI\",\"TUSD\",\"FDUSD\",\"USDE\",\"PYUSD\",\"BUSD\",\"USDD\"]),y=e=>{const t=typeof e==\"number\"?e:Number(e);return Number.isFinite(t)?t:NaN},V=e=>e.length?e.reduce((t,s)=>t+s,0)/e.length:NaN;function de(e){return String(e).toUpperCase().replace(/USDT$/,\"\").replace(/^(1000000|10000|1000)/,\"\")}function st(e){return`https://www.bybi\\\nt.com/trade/usdt/${encodeURIComponent(String(e).toUpperCase())}`}function it(e,t,s,n){const i=de(e);if(Ze.includes(i))return{isMeme:!0,confidence:\"high\",reasons:[`${i} \\u5728\\u660E\\u78BA\\u8FF7\\u56E0\\u5E63\\u6E05\\u55AE\\u5167`]};if(Qe.includes(i))return{isMeme:!1,confidence:\"high\",reasons:[`${i} \\u5728\\u4E3B\\u6D41\\u6A19\\u7684\\u6E05\\u55AE\\u5167`]};const r=[];return/^(1000000|10000|1000)[A-Z]/.test(String(\ne).toUpperCase())&&r.push(\"\\u5E36\\u6709\\u9762\\u984D\\u524D\\u7DB4\\uFF0C\\u5C6C\\u6975\\u4F4E\\u55AE\\u50F9\\u6A19\\u7684\"),Number.isFinite(t)&&t<180&&r.push(`\\u4E0A\\u7DDA\\u50C5 ${Math.round(t)} \\u5929`),Number.isFinite(s)&&Number.isFinite(n)&&n>0&&s/n>8&&r.push(`\\u6210\\u4EA4\\u984D\\u70BA\\u672A\\u5E73\\u5009\\u503C\\u7684 ${(s/n).toFixed(1)} \\u500D`),r.length>=2?{isMeme:!0,confidence:\"medium\",reasons:r}:r.length===\n1?{isMeme:!0,confidence:\"low\",reasons:r}:{isMeme:!0,confidence:\"low\",reasons:[`${i} \\u4E0D\\u5728\\u5DF2\\u77E5\\u4E3B\\u6D41\\u6E05\\u55AE\\u5167\\uFF0C\\u4F9D\\u4FDD\\u5B88\\u539F\\u5247\\u5957\\u7528\\u76F8\\u540C\\u98A8\\u63A7`]}}function rt(e){return e.isMeme?e.confidence===\"high\"?\"\\u8FF7\\u56E0\\u5E63 \\xB7 \\u56FA\\u5B9A 0.15% \\u9632\\u5B88\\u5009\":e.confidence===\"medium\"?\"\\u7591\\u4F3C\\u8FF7\\u56E0\\u5E63 \\xB7 \\u4FDD\\u5B88 0.15% \\u5009\\u4F4D\":\n\"\\u672A\\u5217\\u5165\\u4E3B\\u6D41 \\xB7 \\u4FDD\\u5B88 0.15% \\u5009\\u4F4D\":null}function at(e,t,s=Date.now()){const n=new Map;for(const r of t??[])n.set(r.symbol,r);const i=[];for(const r of e??[]){if(r.status&&r.status!==\"Trading\"||r.quoteCoin!==\"USDT\"||r.contractType&&!/LinearPerpetual/i.test(r.contractType)||nt.has(de(r.symbol)))continue;const a=n.get(r.symbol);if(!a)continue;const o=y(a.lastPrice),\nc=y(a.bid1Price),d=y(a.ask1Price),u=y(a.highPrice24h),l=y(a.lowPrice24h),f=y(a.turnover24h),p=y(a.openInterestValue),h=y(a.price24hPcnt)*100,P=y(a.fundingRate)*100,w=y(r.launchTime);if(!Number.isFinite(o)||o<=0)continue;const S=Number.isFinite(c)&&Number.isFinite(d)&&c>0&&d>0?(d-c)/((d+c)/2)*100:NaN,R=Number.isFinite(u)&&Number.isFinite(l)&&u>l?(o-l)/(u-l):NaN,m=Number.isFinite(w)&&w>0?(s-w)/36e5:\nNaN;i.push({symbol:r.symbol,lastPrice:o,turnover24hUsd:f,openInterestUsd:p,listedHours:m,listedDays:Number.isFinite(m)?m/24:NaN,spreadPct:S,change24hPct:h,rangePosition24h:R,fundingRatePct:P,high24h:u,low24h:l})}return i}function q(e){return Number.isFinite(e.turnover24hUsd)&&e.turnover24hUsd>=k.minTurnover24hUsd&&Number.isFinite(e.openInterestUsd)&&e.openInterestUsd>=k.minOpenInterestUsd&&Number.\nisFinite(e.listedHours)&&e.listedHours>=k.minListedHours&&e.listedHours<=k.maxListedHours&&Number.isFinite(e.spreadPct)&&e.spreadPct<=k.maxSpreadPct&&Number.isFinite(e.change24hPct)&&e.change24hPct>=k.minChange24hPct&&e.change24hPct<=k.maxChange24hPct&&Number.isFinite(e.rangePosition24h)&&e.rangePosition24h>=k.minRangePosition&&e.rangePosition24h<=k.maxRangePosition}function pe(e){return[...e].sort(\n(t,s)=>{const n=i=>i.rangePosition24h*.7+Math.min(1,Math.log10(Math.max(i.turnover24hUsd,1))/9)*.3;return n(s)-n(t)}).slice(0,k.maxDetailedAnalysis)}function Vt(e,t){const s=(t??J).map(o=>o.toUpperCase()),n=new Map;for(const o of e??[])n.set(String(o.symbol).toUpperCase(),o);const i=[];for(const o of s){const c=n.get(o);c&&i.push(c)}const r=(e??[]).filter(o=>!s.includes(String(o.symbol).toUpperCase())),\na=pe(r.filter(q));return{main:i,scan:a,all:[...i,...a]}}function ot(e){return(e??[]).map(t=>({t:y(t[0]),open:y(t[1]),high:y(t[2]),low:y(t[3]),close:y(t[4]),volume:y(t[5])})).filter(t=>Number.isFinite(t.close)&&Number.isFinite(t.high)&&Number.isFinite(t.low)).sort((t,s)=>t.t-s.t)}function ct(e){return(e??[]).map(t=>({t:y(t.timestamp),oi:y(t.openInterest)})).filter(t=>Number.isFinite(t.oi)).sort((t,s)=>t.\nt-s.t)}function lt(e,t){const s=e.length,n=e[s-1],i=v=>s-1-v>=0?e[s-1-v].close:NaN,r=(v,K)=>Number.isFinite(v)&&v>0&&Number.isFinite(K)?(K-v)/v*100:NaN,a=r(i(4),n?.close),o=r(i(24),n?.close),c=e.map(v=>(v.high-v.low)/(v.close||1)),d=V(c.slice(-8)),u=V(c.slice(-32,-8)),l=Number.isFinite(d)&&Number.isFinite(u)&&u>0?d/u:NaN,f=e.map(v=>v.volume).filter(Number.isFinite),p=V(f.slice(-3)),h=V(f.slice(-23,\n-3)),P=Number.isFinite(p)&&Number.isFinite(h)&&h>0?p/h:NaN,w=e.slice(0,Math.max(0,s-2)).map(v=>v.high).filter(Number.isFinite),S=w.length?Math.max(...w):NaN,R=Number.isFinite(S)&&Number.isFinite(n?.close)&&n.close>0?(S-n.close)/n.close*100:NaN,m=t[0]?.oi,M=t[t.length-1]?.oi,O=Number.isFinite(m)&&m>0&&Number.isFinite(M)?(M-m)/m*100:NaN,B=s>=2&&Number.isFinite(e[s-1].t)&&Number.isFinite(e[s-2].t)?e[s-\n1].t-e[s-2].t:NaN,W=Number.isFinite(n?.t)&&Number.isFinite(B)?Math.max(0,(Date.now()-(n.t+B))/6e4):NaN;return{change1hPct:a,change6hPct:o,compressionRatio:l,volumeMultiple:P,breakoutDistancePct:R,oiChangePct:O,priorHigh:S,lastClose:n?.close??NaN,dataAgeMinutes:W,intervalMs:B,candleCount:s}}function ut(e){const t=[],s=(r,a)=>{Number.isFinite(a)&&t.push({weight:r,value:Math.max(0,Math.min(1,a))})};if(s(\n30,(1.2-e.compressionRatio)/.7),Number.isFinite(e.volumeMultiple)){const r=e.volumeMultiple,a=r<1?r*.5:r<=2?1:r<=3?1-(r-2)*.3:Math.max(0,.7-(r-3)*.35);s(25,a)}if(Number.isFinite(e.breakoutDistancePct)){const r=e.breakoutDistancePct,a=r<-.8?0:r<=2?1-Math.abs(r-.6)/2.6:Math.max(0,1-(r-2)/3);s(25,a)}if(Number.isFinite(e.oiChangePct)){const r=e.oiChangePct,a=r<0?0:r<=5?Math.min(1,r/2):Math.max(0,1-(r-\n5)/5);s(20,a)}const n=t.reduce((r,a)=>r+a.weight,0);if(n===0)return 0;const i=t.reduce((r,a)=>r+a.weight*a.value,0)/n;return Math.round(i*100)}function dt(e,t){return Number.isFinite(t.breakoutDistancePct)?t.breakoutDistancePct<-N.maxBreakoutOvershootPct?\"EXCLUDED\":e>=g.minScore&&t.breakoutDistancePct<=g.maxBreakoutDistancePct?\"NEAR_BREAKOUT\":e>=60?\"BUILDING\":\"WATCH\":\"WATCH\"}const pt=Object.freeze(\n{NEAR_BREAKOUT:\"\\u63A5\\u8FD1\\u7A81\\u7834\",BUILDING:\"\\u919E\\u91C0\\u4E2D\",WATCH:\"\\u89C0\\u5BDF\",EXCLUDED:\"\\u5DF2\\u6392\\u9664\"}),T=e=>Number.isFinite(e)?`${e.toFixed(2)}%`:\"\\u7121\\u8CC7\\u6599\",fe=e=>Number.isFinite(e)?`${e.toFixed(3)} \\u500D`:\"\\u7121\\u8CC7\\u6599\",me=e=>Number.isFinite(e)?e.toFixed(3):\"\\u7121\\u8CC7\\u6599\",z=(e,t,s)=>Number.isFinite(e)&&e>=t&&e<=s;function ft(e){const t=(i,r,a,o,c)=>({id:i,\nlabel:r,passed:a,actualText:o,requirement:c,reason:a?null:`${r} ${o}\\uFF08\\u9700 ${c}\\uFF09`}),s=[t(\"score\",\"\\u5206\\u6578\",Number.isFinite(e.score)&&e.score>=g.minScore,Number.isFinite(e.score)?`${e.score} \\u5206`:\"\\u7121\\u8CC7\\u6599\",`\\u2265 ${g.minScore} \\u5206`),t(\"stage\",\"\\u7B49\\u7D1A\",e.stage===\"NEAR_BREAKOUT\",pt[e.stage]??\"\\u7121\\u8CC7\\u6599\",\"\\u63A5\\u8FD1\\u7A81\\u7834\"),t(\"breakout\",\"\\u8DDD\\u7A81\\u7834\\u9EDE\",\nz(e.breakoutDistancePct,g.minBreakoutDistancePct,g.maxBreakoutDistancePct),T(e.breakoutDistancePct),`${g.minBreakoutDistancePct}% \\uFF5E ${g.maxBreakoutDistancePct}%`),t(\"compression\",\"15m \\u58D3\\u7E2E\\u6BD4\",Number.isFinite(e.compressionRatio)&&e.compressionRatio<=g.maxCompressionRatio,me(e.compressionRatio),`\\u2264 ${g.maxCompressionRatio}`),t(\"volume\",\"\\u91CF\\u80FD\",z(e.volumeMultiple,g.minVolumeMultiple,\ng.maxVolumeMultiple),fe(e.volumeMultiple),`${g.minVolumeMultiple} \\uFF5E ${g.maxVolumeMultiple} \\u500D`),t(\"oi\",\"OI \\u8B8A\\u5316\",z(e.oiChangePct,g.minOiChangePct,g.maxOiChangePct),T(e.oiChangePct),`${g.minOiChangePct}% \\uFF5E ${g.maxOiChangePct}%`),t(\"change1h\",\"1H \\u6F32\\u8DCC\",z(e.change1hPct,g.minChange1hPct,g.maxChange1hPct),T(e.change1hPct),`${g.minChange1hPct}% \\uFF5E ${g.maxChange1hPct}%`),\nt(\"change6h\",\"6H \\u6F32\\u8DCC\",z(e.change6hPct,g.minChange6hPct,g.maxChange6hPct),T(e.change6hPct),`${g.minChange6hPct}% \\uFF5E ${g.maxChange6hPct}%`),t(\"risk\",\"\\u98A8\\u96AA\\u6A19\\u8A18\",(e.riskFlags??[]).length===0,(e.riskFlags??[]).length?`${e.riskFlags.length} \\u9805`:\"\\u7121\",\"\\u7121\\u98A8\\u96AA\\u6A19\\u8A18\"),t(\"fresh\",\"\\u8CC7\\u6599\\u5E74\\u9F61\",Number.isFinite(e.dataAgeMinutes)&&e.dataAgeMinutes<=\ng.maxDataAgeMinutes,Number.isFinite(e.dataAgeMinutes)?`${Math.round(e.dataAgeMinutes)} \\u5206\\u9418`:\"\\u7121\\u8CC7\\u6599\",`\\u2264 ${g.maxDataAgeMinutes} \\u5206\\u9418`)],n=s.filter(i=>!i.passed);return{gates:s,ready:n.length===0,reasons:n.map(i=>i.reason),readiness:{passed:s.length-n.length,total:s.length}}}function mt(e){const t=[];return e.change24hPct>N.maxChange24hPct&&t.push(`24H \\u6F32\\u5E45 ${T(\ne.change24hPct)} \\u5DF2\\u8D85\\u904E ${N.maxChange24hPct}%`),e.change1hPct>N.maxChange1hPct&&t.push(`1H \\u6F32\\u5E45 ${T(e.change1hPct)} \\u5DF2\\u8D85\\u904E ${N.maxChange1hPct}%`),e.change6hPct>N.maxChange6hPct&&t.push(`6H \\u6F32\\u5E45 ${T(e.change6hPct)} \\u5DF2\\u8D85\\u904E ${N.maxChange6hPct}%`),e.breakoutDistancePct<-N.maxBreakoutOvershootPct&&t.push(`\\u5DF2\\u7A81\\u7834\\u524D\\u9AD8 ${Math.abs(e.breakoutDistancePct).\ntoFixed(2)}%`),e.volumeMultiple>N.maxVolumeMultiple&&t.push(`\\u91CF\\u80FD ${fe(e.volumeMultiple)} \\u5DF2\\u66B4\\u885D`),e.breakoutDistancePct>N.maxBreakoutDistancePct&&t.push(`\\u8DDD\\u7A81\\u7834\\u9EDE\\u4ECD\\u6709 ${T(e.breakoutDistancePct)}`),e.compressionRatio>N.maxCompressionRatio&&t.push(`\\u58D3\\u7E2E\\u6BD4 ${me(e.compressionRatio)} \\u904E\\u5927`),Math.abs(e.fundingRatePct)>N.maxAbsFundingRatePct&&\nt.push(`\\u8CC7\\u91D1\\u8CBB\\u7387 ${e.fundingRatePct.toFixed(4)}% \\u904E\\u5EA6\\u6975\\u7AEF`),t}function gt(e,t){if(!Number.isFinite(e)||e<=0)return NaN;const s=.5,n=2.5,i=(t??[]).slice(-12).map(d=>d.low).filter(Number.isFinite),r=i.length?Math.min(...i):NaN,a=Number.isFinite(r)?r*.998:e*.985,o=(e-a)/e*100,c=Math.min(n,Math.max(s,o));return e*(1-c/100)}function bt(e,t){if(!Number.isFinite(e)||!Number.\nisFinite(t))return null;const s=e-t;return s>0?{riskPerUnit:s,takeProfit1:e+s*1.5,takeProfit2:e+s*2.5}:null}function ht(e){const t=s=>(s??[]).map(([n,i])=>({price:y(n),size:y(i)})).filter(n=>Number.isFinite(n.price)&&Number.isFinite(n.size)&&n.price>0&&n.size>0);return{bids:t(e?.b).sort((s,n)=>n.price-s.price),asks:t(e?.a).sort((s,n)=>s.price-n.price)}}function ge(e,t=.3){const s=e.bids[0]?.price,\nn=e.asks[0]?.price;if(!Number.isFinite(s)||!Number.isFinite(n))return{mid:NaN,bidUsd:0,askUsd:0,thinnerSideUsd:0};const i=(s+n)/2,r=1e-9,a=i*(1-t/100)*(1-r),o=i*(1+t/100)*(1+r),c=e.bids.filter(u=>u.price>=a).reduce((u,l)=>u+l.price*l.size,0),d=e.asks.filter(u=>u.price<=o).reduce((u,l)=>u+l.price*l.size,0);return{mid:i,bidUsd:c,askUsd:d,thinnerSideUsd:Math.min(c,d)}}function be(e,t=10){return!Number.\nisFinite(e)||e<=0?0:e*(t/100)}function xt(e,t,s,n){const i=lt(t,s),r=ut(i),a=dt(r,i),o=it(e.symbol,e.listedDays,e.turnover24hUsd,e.openInterestUsd),c={symbol:e.symbol,provider:le,lastPrice:e.lastPrice,score:r,stage:a,change24hPct:e.change24hPct,fundingRatePct:e.fundingRatePct,turnover24hUsd:e.turnover24hUsd,openInterestUsd:e.openInterestUsd,listedDays:e.listedDays,spreadPct:e.spreadPct,...i,riskFlags:[],\nisMeme:o.isMeme,memeReasons:o.reasons,memeConfidence:o.confidence,autoTradeEligible:!1},d=mt(c),u=ft(c),l=u.ready&&d.length===0,f=l?gt(i.lastClose,t):NaN,p=l?bt(i.lastClose,f):null,h=n?ge(n):null,P=h?be(h.thinnerSideUsd):0;return{...c,stage:d.length?\"EXCLUDED\":a,entryReady:l,entryLow:l&&p?i.lastClose-p.riskPerUnit*.15:null,entryHigh:l?i.lastClose:null,stopLoss:l&&p?f:null,takeProfit1:p?.takeProfit1??\nnull,takeProfit2:p?.takeProfit2??null,riskPerUnit:p?.riskPerUnit??null,gates:u.gates,readiness:u.readiness,blockingReasons:[...d,...u.reasons],staleWarning:Number.isFinite(i.dataAgeMinutes)&&i.dataAgeMinutes>g.staleWarningMinutes,depthUsd:h?h.thinnerSideUsd:null,maxPositionUsd:P,suggestedRiskPercent:o.isMeme?et:null,riskLabel:rt(o),group:tt(e.symbol,o.isMeme),bybitUrl:st(e.symbol)}}function Gt(e){\nreturn[...e].sort((t,s)=>t.entryReady!==s.entryReady?t.entryReady?-1:1:s.score-t.score).slice(0,ue)}function Wt(e){const t=[];return e.autoTradeEligible!==!1&&t.push(\"autoTradeEligible \\u5FC5\\u9808\\u6C38\\u9060\\u662F false\"),e.entryReady&&e.blockingReasons.length&&t.push(\"entryReady \\u70BA true \\u4F46\\u4ECD\\u6709\\u963B\\u64CB\\u539F\\u56E0\"),e.entryReady&&(e.stopLoss===null||e.takeProfit1===null||e.takeProfit2===\nnull)&&t.push(\"entryReady \\u70BA true \\u4F46\\u7F3A\\u5C11 SL \\u6216 TP\"),!e.entryReady&&(e.stopLoss!==null||e.takeProfit1!==null)&&t.push(\"\\u672A\\u5C31\\u7DD2\\u537B\\u5E36\\u51FA SL \\u6216 TP\"),e.stage===\"EXCLUDED\"&&e.entryReady&&t.push(\"\\u5DF2\\u6392\\u9664\\u537B\\u6A19\\u8A18\\u70BA\\u53EF\\u9032\\u5834\"),/^https:\\/\\/www\\.bybit\\.com\\//.test(e.bybitUrl)||t.push(\"\\u9023\\u7D50\\u672A\\u6307\\u5411 Bybit\"),t}function yt(e){\nconst t=(n,i)=>n.entryReady!==i.entryReady?n.entryReady?-1:1:i.score-n.score,s=e??[];return{main:s.filter(n=>n.group===\"main\").sort(t),meme:s.filter(n=>n.group===\"meme\").sort(t).slice(0,ue)}}const C=e=>String(e).replace(/[&<>\"]/g,t=>({\"&\":\"&amp;\",\"<\":\"&lt;\",\">\":\"&gt;\",'\"':\"&quot;\"})[t]),he=e=>C(e).replace(/\\r?\\n/g,\"<br>\"),vt={NEAR_BREAKOUT:\"\\u63A5\\u8FD1\\u7A81\\u7834\",BUILDING:\"\\u919E\\u91C0\\u4E2D\",WATCH:\"\\\n\\u89C0\\u5BDF\",EXCLUDED:\"\\u5DF2\\u6392\\u9664\"};function xe(e){const t=j(e.lastPrice),s=e.stage===\"NEAR_BREAKOUT\"?\"near\":e.stage===\"EXCLUDED\"?\"excl\":\"build\",n=Array.from({length:e.readiness.total},(o,c)=>'<i class=\"dot'+(c<e.readiness.passed?\" on\":\"\")+'\"></i>').join(\"\"),i=e.entryReady?`\n    <div class=\"entry\">\n      <div class=\"erow\"><span>Entry \\u5340</span><b>${b(e.entryLow,t)} \\u2013 ${b(e.entryHigh,t)}</b></div>\n      <div class=\"erow sl\"><span>\\u505C\\u640D SL</span><b>${b(e.stopLoss,t)}</b></div>\n      <div class=\"erow tp\"><span>TP1 \\xB7 1.5R</span><b>${b(e.takeProfit1,t)}</b></div>\n      <div class=\"erow tp\"><span>TP2 \\xB7 2.5R</span><b>${b(e.takeProfit2,t)}</b></div>\n      ${e.maxPositionUsd>0?'<div class=\"erow\"><span>\\u76E4\\u53E3\\u53EF\\u627F\\u53D7</span><b>\\u7D04 '+X(e.maxPositionUsd)+\" USDT</b></div>\":\"\"}\n    </div>`:\"\",r=e.blockingReasons.length?'<div class=\"reasons\">'+e.blockingReasons.map(o=>\"<div>\"+C(o)+\"</div>\").join(\"\")+\"</div>\":\"\",a=e.staleWarning?'<div class=\"banner\"><div class=\"bt\">\\u8CC7\\u6599\\u504F\\u820A</div><div class=\"bd\">\\u6B64\\u6A19\\u7684\\u8CC7\\u6599\\u5DF2 '+Math.round(e.dataAgeMinutes)+\" \\u5206\\u9418\\u672A\\u66F4\\u65B0\\u3002</div></div>\":\"\";return`\n  <div class=\"card ${e.entryReady?\"ready\":\"\"} ${e.stage===\"EXCLUDED\"?\"excluded\":\"\"}\">\n    <div class=\"chead\">\n      <span class=\"sym\">${C(e.symbol)}</span>\n      <span class=\"tag ${s}\">${vt[e.stage]??C(e.stage)}</span>\n      ${e.riskLabel?'<span class=\"tag meme\">'+C(e.riskLabel)+\"</span>\":\"\"}\n      <span class=\"score\"><b>${e.score}</b><span>\\u5B8C\\u6210\\u5EA6</span></span>\n    </div>\n\n    <div class=\"readiness\">\n      <span class=\"dots\">${n}</span>\n      <span class=\"rtext\">\\u9032\\u5834\\u689D\\u4EF6 ${e.readiness.passed}/${e.readiness.total}</span>\n    </div>\n\n    ${i}\n    ${r}\n    ${a}\n\n    <div class=\"grid\">\n      <div class=\"cell\"><span>\\u73FE\\u50F9</span><b>${b(e.lastPrice,t)}</b></div>\n      <div class=\"cell\"><span>\\u8DDD\\u7A81\\u7834\\u9EDE</span><b>${D(e.breakoutDistancePct)}</b></div>\n      <div class=\"cell\"><span>15m \\u58D3\\u7E2E\\u6BD4</span><b>${b(e.compressionRatio,3)}</b></div>\n      <div class=\"cell\"><span>\\u91CF\\u80FD\\u500D\\u7387</span><b>${b(e.volumeMultiple,2)}x</b></div>\n      <div class=\"cell\"><span>OI \\u8B8A\\u5316</span><b class=\"${F(e.oiChangePct)}\">${D(e.oiChangePct)}</b></div>\n      <div class=\"cell\"><span>\\u8CC7\\u91D1\\u8CBB\\u7387</span><b>${b(e.fundingRatePct,4)}%</b></div>\n      <div class=\"cell\"><span>1H / 6H</span><b><span class=\"${F(e.change1hPct)}\">${D(e.change1hPct)}</span> / <span class=\"${F(e.change6hPct)}\">${D(e.change6hPct)}</span></b></div>\n      <div class=\"cell\"><span>24H \\u6210\\u4EA4\\u984D</span><b>${X(e.turnover24hUsd)}</b></div>\n    </div>\n\n    <div class=\"foot\">\n      <a href=\"${e.bybitUrl}\" target=\"_blank\" rel=\"noopener noreferrer\">\\u5728 Bybit \\u958B\\u555F\\u5408\\u7D04 \\u2197</a>\n      <span class=\"noauto\">\\u50C5\\u4F9B\\u7814\\u7A76\\u89C0\\u5BDF \\xB7 \\u4E0D\\u81EA\\u52D5\\u4E0B\\u55AE</span>\n    </div>\n  </div>`}function Pt(e){if(!e)return\"\";if(e.error)return`<h2>Bybit \\u5E33\\u6236</h2>\n      <div class=\"banner err\">\n        <div class=\"bt\">\\u7121\\u6CD5\\u8B80\\u53D6\\u5E33\\u6236\\u8CC7\\u6599</div>\n        <div class=\"bd\">${he(e.error)}</div>\n      </div>`;const t=e.wallet,s=e.positions??[],n=e.todayPnl,i=t?`\n    <div class=\"grid\">\n      <div class=\"cell\"><span>\\u7E3D\\u6B0A\\u76CA</span><b>${L(t.totalEquityUsd)} USDT</b></div>\n      <div class=\"cell\"><span>\\u53EF\\u7528</span><b>${L(t.totalAvailableUsd)} USDT</b></div>\n      <div class=\"cell\"><span>\\u672A\\u5BE6\\u73FE</span><b class=\"${F(t.unrealizedPnlUsd)}\">${L(t.unrealizedPnlUsd)}</b></div>\n      <div class=\"cell\"><span>\\u4ECA\\u65E5\\u5DF2\\u5BE6\\u73FE</span><b class=\"${F(n?.total)}\">${L(n?.total)}</b></div>\n    </div>`:\"\",r=s.length?s.map(a=>{const o=a.protection??{level:\"danger\",text:\"\\u672A\\u77E5\"},c=j(a.entryPrice);return`\n        <div class=\"card ${o.level===\"ok\"?\"\":\"excluded\"}\">\n          <div class=\"chead\">\n            <span class=\"sym\">${C(a.symbol)}</span>\n            <span class=\"tag ${a.side===\"long\"?\"near\":\"excl\"}\">${a.side===\"long\"?\"\\u25B2 \\u591A\":\"\\u25BC \\u7A7A\"}</span>\n            <span class=\"tag ${o.level===\"ok\"?\"build\":\"meme\"}\">${C(o.text)}</span>\n            <span class=\"score\"><b class=\"${F(a.unrealizedPnl)}\">${L(a.unrealizedPnl)}</b><span>\\u672A\\u5BE6\\u73FE</span></span>\n          </div>\n          <div class=\"grid\">\n            <div class=\"cell\"><span>\\u9032\\u5834</span><b>${b(a.entryPrice,c)}</b></div>\n            <div class=\"cell\"><span>\\u6A19\\u8A18\\u50F9</span><b>${b(a.markPrice,c)}</b></div>\n            <div class=\"cell\"><span>\\u6578\\u91CF</span><b>${b(a.size,4)}</b></div>\n            <div class=\"cell\"><span>\\u69D3\\u687F</span><b>${b(a.leverage,0)}x</b></div>\n            <div class=\"cell\"><span>TP</span><b>${a.takeProfit>0?b(a.takeProfit,c):\"\\u672A\\u8A2D\\u5B9A\"}</b></div>\n            <div class=\"cell\"><span>SL</span><b>${a.stopLoss>0?b(a.stopLoss,c):\"\\u672A\\u8A2D\\u5B9A\"}</b></div>\n          </div>\n        </div>`}).join(\"\"):'<div class=\"empty\">\\u76EE\\u524D\\u6C92\\u6709\\u6301\\u5009\\u3002</div>';return`<h2>Bybit \\u5E33\\u6236 \\xB7 \\u552F\\u8B80</h2>\n    <div class=\"card\">\n      <div class=\"chead\">\n        <span class=\"sym\">\\u5E33\\u6236\\u6458\\u8981</span>\n        <span class=\"tag build\">${C(e.keyMask??\"\\u5DF2\\u9023\\u63A5\")}</span>\n        <span class=\"noauto\" style=\"margin-left:auto\">\\u552F\\u8B80 \\xB7 \\u4E0D\\u6703\\u4E0B\\u55AE</span>\n      </div>\n      ${i}\n    </div>\n    ${r}`}function ye(e,t,s,n){if(!s.length)return`<h2>${e}</h2><div class=\"empty\">${n}</div>`;const i=s.filter(o=>o.entryReady),r=s.filter(o=>!o.entryReady);let a=`<h2>${e} \\xB7 ${s.length} \\u6A94</h2>`;return t&&(a+=`<div class=\"note\" style=\"margin:0 0 10px\">${t}</div>`),i.length&&(a+=`<div class=\"subhead\">\\u7B26\\u5408\\u5168\\u90E8\\u9032\\u5834\\u689D\\u4EF6 \\xB7 ${i.length} \\u6A94</div>`+i.map(xe).\njoin(\"\")),r.length&&(a+=`<div class=\"subhead\">\\u89C0\\u5BDF\\u4E2D \\xB7 ${r.length} \\u6A94</div>`+r.map(xe).join(\"\")),a}function Nt(e){let t=\"\";e.error&&(t+=`<div class=\"banner err\">\n      <div class=\"bt\">\\u7121\\u6CD5\\u53D6\\u5F97 Bybit \\u8CC7\\u6599</div>\n      <div class=\"bd\">${he(e.error)}</div>\n    </div>`),e.failed&&e.failed.length&&(t+=`<div class=\"banner\">\n      <div class=\"bt\">${e.failed.length} \\u6A94\\u6A19\\u7684\\u8CC7\\u6599\\u6293\\u53D6\\u5931\\u6557</div>\n      <div class=\"bd\">${e.failed.map(n=>C(n.symbol)).join(\"\\u3001\")}</div>\n    </div>`),t+=Pt(e.account);const s=e.groups??{main:[],meme:[]};return!e.busy&&e.scannedAt&&(t+=ye(\"\\u4E3B\\u5E63\",\"\\u56FA\\u5B9A\\u89C0\\u5BDF\\u6E05\\u55AE\\uFF0C\\u4E0D\\u8AD6\\u662F\\u5426\\u7B26\\u5408\\u5FEB\\u5674\\u578B\\u614B\\u90FD\\u6703\\u986F\\u793A\\u76EE\\u524D\\u72C0\\u614B\\u3002\",s.main,\"\\u4E3B\\u5E63\\u8CC7\\u6599\\u5C1A\\u672A\\u53D6\\u5F97\\u3002\"),t+=ye(\"\\u8FF7\\u56E0\\u5E63\\uFF0F\\u9AD8\\u98A8\\u96AA\",\"\\u4E00\\u5F8B\\u5957\\u7528\\u56FA\\u5B9A 0\\\n.15% \\u9632\\u5B88\\u5009\\uFF0C\\u4E0D\\u56E0\\u5206\\u6578\\u63D0\\u9AD8\\u5009\\u4F4D\\u3002\\u5224\\u65B7\\u4E0D\\u51FA\\u4F86\\u7684\\u6A19\\u7684\\u4E5F\\u6B78\\u5728\\u9019\\u4E00\\u5340\\u3002\",s.meme,\"\\u76EE\\u524D\\u6C92\\u6709\\u7B26\\u5408\\u689D\\u4EF6\\u7684\\u5019\\u9078\\u3002\\u591A\\u6578\\u6642\\u9593\\u5E02\\u5834\\u90FD\\u4E0D\\u5728\\u58D3\\u7E2E\\u5F85\\u7A81\\u7834\\u7684\\u72C0\\u614B\\u3002\")),t}function wt(e){return!e.scannedAt||\ne.busy?\"\":`\\u901A\\u904E\\u7B2C\\u4E00\\u968E\\u6BB5 ${e.universeCount} \\u6A94\\uFF0C\\u8A73\\u7D30\\u5206\\u6790 ${e.analyzedCount} \\u6A94`}const St=`\n  <div class=\"disc\">\n    <b>\\u4F7F\\u7528\\u524D\\u8ACB\\u52D9\\u5FC5\\u4E86\\u89E3</b>\n    <ul>\n      <li>\\u672C\\u9801\\u53EA\\u8B80\\u53D6 Bybit \\u516C\\u958B\\u884C\\u60C5\\u7AEF\\u9EDE\\uFF0C<strong>\\u4E0D\\u9023\\u63A5\\u4EFB\\u4F55\\u5E33\\u6236\\u3001\\u4E0D\\u9700\\u8981\\u4E5F\\u4E0D\\u63A5\\u53D7 API Key</strong>\\uFF0C\\u4E26\\u4E14<strong>\\u6C38\\u9060\\u4E0D\\u6703\\u4E0B\\u55AE</strong>\\u3002</li>\n      <li>\\u5B8C\\u6210\\u5EA6\\u5206\\u6578\\u8861\\u91CF\\u7684\\u662F\\u300C\\u578B\\u614B\\u6210\\u719F\\u7A0B\\u5EA6\\u300D\\uFF0C<strong>\\u4E0D\\u662F\\u52DD\\u7387\\uFF0C\\u4E5F\\u4E0D\\u662F\\u5831\\u916C\\u9810\\u671F</strong>\\u3002\\u5206\\u6578\\u9AD8\\u4E0D\\u7B49\\u65BC\\u53EF\\u4EE5\\u9032\\u5834\\uFF0C\\u5FC5\\u9808\\u5341\\u9805\\u9032\\u5834\\u689D\\u4EF6\\u5168\\u90E8\\u901A\\u904E\\u3002</li>\n      <li>Entry\\u3001SL\\u3001TP \\u70BA\\u4F9D 1.5R \\u8207 2.5R \\u6A5F\\u68B0\\u63DB\\u7B97\\u7684\\u53C3\\u8003\\u503C\\uFF0C\\u4E0D\\u662F\\u6295\\u8CC7\\u5EFA\\u8B70\\u3002\\u5BE6\\u969B\\u4E0B\\u55AE\\u524D\\u8ACB\\u81EA\\u884C\\u78BA\\u8A8D\\u76E4\\u53E3\\u6DF1\\u5EA6\\u8207\\u53EF\\u627F\\u53D7\\u98A8\\u96AA\\u3002</li>\n      <li>\\u8FF7\\u56E0\\u5E63\\u4E00\\u5F8B\\u6A19\\u8A18\\u4E26\\u5957\\u7528\\u56FA\\u5B9A 0.15% \\u9632\\u5B88\\u5009\\uFF0C\\u4E0D\\u56E0\\u5206\\u6578\\u63D0\\u9AD8\\u5009\\u4F4D\\u3002</li>\n      <li>\\u52A0\\u5BC6\\u8CA8\\u5E63\\u6C38\\u7E8C\\u5408\\u7D04\\u98A8\\u96AA\\u6975\\u9AD8\\uFF0C\\u53EF\\u80FD\\u640D\\u5931\\u5168\\u90E8\\u672C\\u91D1\\u3002\\u672C\\u5DE5\\u5177\\u4E0D\\u5C0D\\u4EFB\\u4F55\\u7D50\\u679C\\u4F5C\\u51FA\\u4FDD\\u8B49\\u3002</li>\n    </ul>\n  </div>`,H=\"Crypto Radar Guardian 10.0\",G=5,$t=9,kt=4,I=Object.freeze({latest:\"state:latest\",heartbeat:\"state:heartbeat\",notify:\"state:notify\"});function At(e){const t=[];for(const s of Object.keys(e||{})){const n=e[s];n==null||n===\"\"||t.push(`${encodeURIComponent(s)}=${encodeURIComponent(String(n))}`)}return t.join(\"&\")}function ve(e,t){const s=t??fetch,n=_(e.BYBIT_ENV);async function i(a,o){const c=At(\no),d=Ce(n)+a+(c?`?${c}`:\"\"),u=await s(d,{headers:{accept:\"application/json\"}});if(!u.ok)throw new Error(`HTTP ${u.status}`);const l=await u.json();if(l.retCode!==0)throw new Error(ne(l.retCode,l.retMsg,n));return l.result}async function r(a,o){const c=U(e.BYBIT_API_KEY),d=U(e.BYBIT_API_SECRET);if(!c||!d)throw new Error(\"\\u672A\\u8A2D\\u5B9A Bybit \\u6191\\u8B49\");const u=_e({path:a,params:o,apiKey:c,apiSecret:d,\ntimestamp:Date.now(),env:n}),l=await s(u.url,{headers:u.headers});if(!l.ok)throw new Error(`HTTP ${l.status}`);const f=await l.json();if(f.retCode!==0)throw new Error(ne(f.retCode,f.retMsg,n));return f.result}return{publicGet:i,signedGet:r,bybitEnv:n,hasCredentials:!!(U(e.BYBIT_API_KEY)&&U(e.BYBIT_API_SECRET))}}function Ct(e,t=$t){const s=J.map(o=>o.toUpperCase()),n=new Map;for(const o of e??[])n.\nset(String(o.symbol).toUpperCase(),o);const i=[];for(const o of s){const c=n.get(o);c&&i.push(c)}const r=(e??[]).filter(o=>!s.includes(String(o.symbol).toUpperCase())),a=pe(r.filter(q)).slice(0,t);return{main:i,scan:a,all:[...i,...a]}}async function Et(e,t=Date.now()){const[s,n]=await Promise.all([e.publicGet(\"/v5/market/instruments-info\",{category:\"linear\",limit:1e3}),e.publicGet(\"/v5/market/tick\\\ners\",{category:\"linear\"})]),i=at(s.list??[],n.list??[],t),r=i.filter(q).length,a=Ct(i),o=[],c=[];for(const l of a.all)try{const[f,p]=await Promise.all([e.publicGet(\"/v5/market/kline\",{category:\"linear\",symbol:l.symbol,interval:15,limit:40}),e.publicGet(\"/v5/market/open-interest\",{category:\"linear\",symbol:l.symbol,intervalTime:\"15min\",limit:5})]);o.push({row:l,candidate:xt(l,ot(f.list),ct(p.list),null)})}catch(f){\nc.push({symbol:l.symbol,error:String(f?.message??f)})}const d=o.filter(l=>l.candidate.entryReady).slice(0,kt);for(const l of d)try{const f=await e.publicGet(\"/v5/market/orderbook\",{category:\"linear\",symbol:l.row.symbol,limit:50}),p=ge(ht(f));l.candidate.depthUsd=p.thinnerSideUsd,l.candidate.maxPositionUsd=be(p.thinnerSideUsd)}catch{}const u=o.map(l=>l.candidate);return{version:H,scannedAt:t,universeCount:r,\nanalyzedCount:a.all.length,candidates:u,groups:yt(u),failed:c,busy:!1,error:null,account:null}}async function Pe(e,t){if(!e.hasCredentials)return null;try{const[s,n,i]=await Promise.all([e.signedGet(\"/v5/account/wallet-balance\",{accountType:\"UNIFIED\"}),e.signedGet(\"/v5/position/list\",{category:\"linear\",settleCoin:\"USDT\"}),e.signedGet(\"/v5/position/closed-pnl\",{category:\"linear\",limit:50})]),r=ze(n).\nmap(a=>({...a,protection:Ke(a)}));return{wallet:Le(s),positions:r,todayPnl:je(He(i),Date.now()-864e5),keyMask:re(U(t.BYBIT_API_KEY)),error:null}}catch(s){const n=String(s?.message??s),i=U(t.BYBIT_API_KEY),r=U(t.BYBIT_API_SECRET);return{error:n.split(i).join(\"[key]\").split(r).join(\"[secret]\"),keyMask:re(i)}}}function Tt(e){const t=e??fetch;return async(s,n)=>{const i=await t(s,{method:\"POST\",headers:{\n\"Content-Type\":\"application/json\"},body:JSON.stringify(n)});if(!i.ok)throw new Error(`Discord \\u56DE\\u61C9 HTTP ${i.status}`)}}async function Rt(e,t,s,n,i=Date.now()){const r=t.DISCORD_WEBHOOK;if(!ae(r))return{sent:0,error:null,skipped:\"\\u672A\\u8A2D\\u5B9A Webhook\"};const a=e.groups??{main:[],meme:[]},o=[...a.main,...a.meme].filter(p=>p.entryReady);let c={sent:{},lastSentAt:null};try{const p=await s.\nget(I.notify);p&&(c=JSON.parse(p))}catch{}const d=Ye(o,c,i);let u=0,l=null;for(const p of d.toSend){const h=await ce(n,r,Ge(p));h.ok?u+=1:l=h.error}if(e.account?.positions){const p=We(e.account.positions);if(p){const h=await ce(n,r,p);h.ok?u+=1:l=h.error}}const f=JSON.stringify(d.state);return f!==JSON.stringify(c)&&await s.put(I.notify,f),{sent:u,error:l,skipped:null}}async function Ut(e,t,s=Date.\nnow()){const n={...t,account:null};await e.put(I.latest,JSON.stringify(n)),await e.put(I.heartbeat,JSON.stringify({at:s,version:H,ok:!t.error,analyzed:t.analyzedCount,failed:t.failed?.length??0}))}async function Z(e){try{const t=await e.get(I.latest);return t?JSON.parse(t):null}catch{return null}}async function Dt(e){try{const t=await e.get(I.heartbeat);return t?JSON.parse(t):null}catch{return null}}\nasync function Ne({env:e,kv:t,fetchImpl:s,now:n=Date.now()}){const i=ve(e,s),r=Tt(s);try{const a=await Et(i,n);a.account=await Pe(i,e);const o=await Rt(a,e,t,r,n);return await Ut(t,a,n),{ok:!0,state:a,notifyResult:o}}catch(a){const o=String(a?.message??a);return await t.put(I.heartbeat,JSON.stringify({at:n,version:H,ok:!1,error:o})),{ok:!1,error:o}}}const Ft={\"content-type\":\"application/json; char\\\nset=utf-8\",\"cache-control\":\"no-store\"},It={\"content-type\":\"text/html; charset=utf-8\",\"cache-control\":\"no-store\"},A=(e,t=200)=>new Response(JSON.stringify(e,null,2),{status:t,headers:Ft});function we(e,t){const s=String(e??\"\"),n=String(t??\"\");if(s.length===0||n.length===0||s.length!==n.length)return!1;let i=0;for(let r=0;r<s.length;r+=1)i|=s.charCodeAt(r)^n.charCodeAt(r);return i===0}function Se(e,t,s){\nconst n=t.ADMIN_TOKEN;if(!n)return!1;if(we(e.searchParams.get(\"token\"),n))return!0;const i=s?.headers?.get?.(\"x-admin-token\");return we(i,n)}function Mt(e,t){return!e||!Number.isFinite(e.at)?null:Math.max(0,Math.round((t-e.at)/1e3))}function Bt(e,t){const s=Mt(e,t),n=G*60*2+60;return s===null?{ok:!1,status:\"no-heartbeat\",ageSeconds:null}:e.ok?s>n?{ok:!1,status:\"stale\",ageSeconds:s}:{ok:!0,status:\"\\\nhealthy\",ageSeconds:s}:{ok:!1,status:\"last-run-failed\",ageSeconds:s}}async function Ot({request:e,env:t,kv:s,now:n=Date.now()}){const i=new URL(e.url),r=i.pathname.replace(/\\/+$/,\"\")||\"/\";if(r===\"/scan\"){if(!t.ADMIN_TOKEN)return A({error:\"\\u672A\\u8A2D\\u5B9A ADMIN_TOKEN\\uFF0C\\u624B\\u52D5\\u89F8\\u767C\\u5DF2\\u505C\\u7528\"},403);if(!Se(i,t,e))return A({error:\"unauthorized\"},401);const c=await Ne({env:t,\nkv:s,now:n});if(!c.ok)return A({ok:!1,error:c.error},500);const d=c.state.groups;return A({ok:!0,scannedAt:c.state.scannedAt,analyzed:c.state.analyzedCount,ready:[...d.main,...d.meme].filter(u=>u.entryReady).length,notified:c.notifyResult?.sent??0})}if(e.method!==\"GET\"&&e.method!==\"HEAD\")return A({error:\"method not allowed\"},405);const a=await Dt(s),o=Bt(a,n);if(r===\"/health\")return A({ok:o.ok,status:o.\nstatus,version:H,heartbeatAt:a?.at??null,ageSeconds:o.ageSeconds},o.ok?200:503);if(r===\"/api/status\"){const c=await Z(s);return A({version:H,engine:qe,health:o.status,ok:o.ok,heartbeatAt:a?.at??null,heartbeatAgeSeconds:o.ageSeconds,cron:`\\u6BCF ${G} \\u5206\\u9418`,moonshotProvider:le,bybitEnvironment:Q[_(t.BYBIT_ENV)],tradeMode:\"read-only\",autoTrading:!1,discordConfigured:!!t.DISCORD_WEBHOOK,bybitAccountConfigured:!!(t.\nBYBIT_API_KEY&&t.BYBIT_API_SECRET),lastScanAt:c?.scannedAt??null,universeCount:c?.universeCount??null,analyzedCount:c?.analyzedCount??null,readyCount:c?[...c.groups?.main??[],...c.groups?.meme??[]].filter(d=>d.entryReady).length:null,failedCount:c?.failed?.length??null})}if(r===\"/api/scan\"){const c=await Z(s);return c?A(c):A({error:\"\\u5C1A\\u672A\\u6709\\u6383\\u63CF\\u7D50\\u679C\"},503)}if(r===\"/\"){const c=await Z(\ns),d=Se(i,t,e)?await Pe(ve(t),t):null;return new Response(Lt(c,d,a,o,t,n),{headers:It})}return A({error:\"not found\"},404)}function _t(e){return Number.isFinite(e)?new Date(e).toISOString().replace(\"T\",\" \").slice(0,16)+\" UTC\":\"\\u2014\"}function Lt(e,t,s,n,i,r){const a=e?.groups??{main:[],meme:[]},o=[...a.main,...a.meme].filter(p=>p.entryReady).length,c=n.ok?\"ok\":\"warn\",d=n.ok?`\\u904B\\u4F5C\\u6B63\\u5E38 \\xB7 \\u5FC3\\u8DF3 ${n.\nageSeconds} \\u79D2\\u524D`:n.status===\"no-heartbeat\"?\"\\u5C1A\\u672A\\u57F7\\u884C\\u904E\\u6392\\u7A0B\\u6383\\u63CF\":n.status===\"last-run-failed\"?\"\\u4E0A\\u4E00\\u6B21\\u6392\\u7A0B\\u57F7\\u884C\\u5931\\u6557\":`\\u5FC3\\u8DF3\\u5DF2 ${Math.round((n.ageSeconds??0)/60)} \\u5206\\u9418\\u672A\\u66F4\\u65B0`,u=n.ok?\"\":`\n    <div class=\"banner\">\n      <div class=\"bt\">${d}</div>\n      <div class=\"bd\">\\u6392\\u7A0B\\u70BA\\u6BCF ${G} \\u5206\\u9418\\u4E00\\u6B21\\u3002\\u82E5\\u6301\\u7E8C\\u7570\\u5E38\\uFF0C\\u8ACB\\u5230 Cloudflare \\u6AA2\\u67E5 Worker \\u7684 Cron \\u89F8\\u767C\\u5668\\u8207\\u8A18\\u9304\\u3002</div>\n    </div>`,l=e?{...e,account:t,busy:!1}:{candidates:[],groups:{main:[],meme:[]},failed:[],scannedAt:null,busy:!1,error:null,account:null},f=t?\"\":`\n    <div style=\"margin-top:6px;color:var(--muted)\">\\u5E33\\u6236\\u8CC7\\u6599\\u672A\\u986F\\u793A\\u3002\\u82E5\\u5DF2\\u8A2D\\u5B9A ADMIN_TOKEN\\uFF0C\\u8ACB\\u5728\\u7DB2\\u5740\\u52A0\\u4E0A <code>?token=\\u4F60\\u7684Token</code>\\u3002</div>`;return`<!doctype html>\n<html lang=\"zh-Hant\">\n<head>\n<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1, viewport-fit=cover\">\n<meta name=\"apple-mobile-web-app-capable\" content=\"yes\">\n<meta name=\"apple-mobile-web-app-status-bar-style\" content=\"black-translucent\">\n<meta name=\"color-scheme\" content=\"dark\">\n<meta name=\"robots\" content=\"noindex, nofollow\">\n<meta http-equiv=\"refresh\" content=\"300\">\n<title>Crypto Radar Guardian</title>\n<style>:root {\n  color-scheme: dark;\n  --bg: #050d17;\n  --panel: #081321;\n  --panel-2: #0b1a2c;\n  --line: rgba(34, 211, 238, 0.16);\n  --line-soft: rgba(34, 211, 238, 0.08);\n  --text: #cfe6f2;\n  --muted: #6d8ca6;\n  --cyan: #22d3ee;\n  --green: #34d399;\n  --amber: #ffb020;\n  --red: #ff4d6d;\n  --violet: #a78bfa;\n}\n* { box-sizing: border-box; }\nhtml, body { margin: 0; background: var(--bg); }\nbody {\n  font: 15px/1.55 -apple-system, BlinkMacSystemFont, \"Segoe UI\", \"Noto Sans TC\", \"PingFang TC\", sans-serif;\n  color: var(--text);\n  padding: env(safe-area-inset-top) env(safe-area-inset-right) env(safe-area-inset-bottom) env(safe-area-inset-left);\n  -webkit-text-size-adjust: 100%;\n}\n.wrap { max-width: 640px; margin: 0 auto; padding: 14px 12px 40px; }\n\nheader { position: sticky; top: 0; z-index: 20; background: linear-gradient(180deg, var(--bg) 72%, transparent); padding-top: 8px; }\n.title { display: flex; align-items: baseline; gap: 8px; flex-wrap: wrap; }\nh1 { font-size: 19px; margin: 0; letter-spacing: .02em; }\n.ver { font-size: 11px; color: var(--muted); font-variant-numeric: tabular-nums; }\n.srcbadge {\n  display: inline-flex; align-items: center; gap: 5px;\n  font-size: 11px; color: var(--cyan); border: 1px solid var(--line);\n  border-radius: 999px; padding: 2px 9px; background: rgba(34, 211, 238, .06);\n}\n.srcbadge b { font-weight: 600; }\n\n.bar { display: flex; gap: 8px; align-items: center; margin-top: 10px; }\nbutton {\n  font: inherit; font-size: 14px; color: var(--text);\n  background: var(--panel-2); border: 1px solid var(--line);\n  border-radius: 10px; padding: 9px 14px; cursor: pointer;\n  min-height: 42px; -webkit-tap-highlight-color: transparent;\n}\nbutton:active { background: #10263c; }\nbutton[disabled] { opacity: .5; cursor: default; }\nbutton.primary { border-color: rgba(34, 211, 238, .45); color: #e6fbff; }\n.meta { font-size: 12px; color: var(--muted); font-variant-numeric: tabular-nums; margin-left: auto; text-align: right; }\n\n.note {\n  margin: 12px 0 0; padding: 10px 12px; border-radius: 10px;\n  background: var(--panel); border: 1px solid var(--line-soft);\n  font-size: 12.5px; color: var(--muted);\n}\n.note strong { color: var(--text); font-weight: 600; }\n\n.banner { margin-top: 12px; padding: 11px 13px; border-radius: 11px; background: var(--panel); border-left: 3px solid var(--amber); }\n.banner.err { border-left-color: var(--red); }\n.banner .bt { font-size: 13.5px; color: #ffe9c2; font-weight: 600; }\n.banner.err .bt { color: #ffd6de; }\n.banner .bd { font-size: 12.5px; color: var(--muted); margin-top: 3px; }\n\n.progress { height: 3px; background: var(--panel-2); border-radius: 2px; overflow: hidden; margin-top: 12px; }\n.progress i { display: block; height: 100%; background: linear-gradient(90deg, var(--cyan), var(--violet)); width: 0; transition: width .25s ease; }\n\nh2 { font-size: 13px; color: var(--muted); font-weight: 600; letter-spacing: .06em; margin: 22px 0 10px; text-transform: uppercase; }\n\n.card {\n  background: var(--panel); border: 1px solid var(--line-soft);\n  border-radius: 13px; padding: 13px; margin-bottom: 11px;\n}\n.card.ready { border-color: rgba(52, 211, 153, .38); box-shadow: 0 0 0 1px rgba(52, 211, 153, .09), 0 6px 22px -14px rgba(52, 211, 153, .5); }\n.card.excluded { opacity: .72; }\n\n.chead { display: flex; align-items: center; gap: 9px; flex-wrap: wrap; }\n.sym { font-size: 17px; font-weight: 650; letter-spacing: .01em; }\n.tag { font-size: 10.5px; padding: 2px 7px; border-radius: 5px; border: 1px solid var(--line); color: var(--muted); white-space: nowrap; }\n.tag.near { color: var(--green); border-color: rgba(52, 211, 153, .4); }\n.tag.build { color: var(--cyan); border-color: rgba(34, 211, 238, .35); }\n.tag.excl { color: var(--red); border-color: rgba(255, 77, 109, .35); }\n.tag.meme { color: var(--amber); border-color: rgba(255, 176, 32, .4); }\n.score { margin-left: auto; text-align: right; }\n.score b { font-size: 21px; font-variant-numeric: tabular-nums; letter-spacing: -.01em; }\n.score span { display: block; font-size: 10.5px; color: var(--muted); }\n\n.readiness { display: flex; align-items: center; gap: 8px; margin-top: 10px; }\n.dots { display: flex; gap: 3px; }\n.dot { width: 7px; height: 7px; border-radius: 2px; background: rgba(255,255,255,.13); }\n.dot.on { background: var(--green); }\n.rtext { font-size: 12px; color: var(--muted); font-variant-numeric: tabular-nums; }\n\n.reasons { margin: 9px 0 0; padding: 9px 11px; border-radius: 9px; background: rgba(255, 77, 109, .06); border: 1px solid rgba(255, 77, 109, .18); }\n.reasons div { font-size: 12.5px; color: #ffc9d4; padding: 1.5px 0; }\n.reasons div::before { content: \"\\u2715 \"; color: var(--red); }\n\n.entry { margin-top: 10px; padding: 10px 11px; border-radius: 9px; background: rgba(52, 211, 153, .06); border: 1px solid rgba(52, 211, 153, .2); }\n.erow { display: flex; justify-content: space-between; font-size: 13px; padding: 2.5px 0; font-variant-numeric: tabular-nums; }\n.erow span { color: var(--muted); }\n.erow b { font-weight: 600; }\n.erow.tp b { color: var(--green); }\n.erow.sl b { color: var(--red); }\n\n.grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 7px 12px; margin-top: 11px; }\n.cell { font-size: 12px; display: flex; justify-content: space-between; gap: 6px; font-variant-numeric: tabular-nums; }\n.cell span { color: var(--muted); }\n.cell b { font-weight: 600; }\n.pos { color: var(--green); }\n.neg { color: var(--red); }\n\n.foot { display: flex; align-items: center; gap: 10px; margin-top: 11px; padding-top: 10px; border-top: 1px solid var(--line-soft); }\n.foot a { color: var(--cyan); font-size: 12.5px; text-decoration: none; border-bottom: 1px solid rgba(34,211,238,.3); }\n.noauto { font-size: 11px; color: var(--muted); margin-left: auto; }\n\n.empty { padding: 26px 14px; text-align: center; color: var(--muted); font-size: 13.5px; background: var(--panel); border-radius: 12px; border: 1px dashed var(--line-soft); }\n\n.disc { margin-top: 26px; padding: 13px; border-radius: 11px; background: var(--panel); border: 1px solid var(--line-soft); font-size: 11.5px; line-height: 1.65; color: var(--muted); }\n.disc b { color: var(--text); display: block; margin-bottom: 5px; font-size: 12.5px; }\n.disc li { margin: 3px 0; }\n.disc ul { margin: 5px 0 0; padding-left: 17px; }\n\n@media (max-width: 380px) { .grid { grid-template-columns: 1fr; } h1 { font-size: 17px; } }\n\n.subhead {\n  font-size: 12px; color: var(--muted); margin: 14px 0 8px;\n  display: flex; align-items: center; gap: 8px;\n}\n.subhead::after { content: \"\"; flex: 1; height: 1px; background: var(--line-soft); }</style>\n</head>\n<body>\n<div class=\"wrap\">\n  <header>\n    <div class=\"title\">\n      <h1>Crypto Radar Guardian</h1>\n      <span class=\"ver\">v10.0 \\xB7 Cloudflare Worker</span>\n    </div>\n    <div style=\"margin-top:6px\">\n      <span class=\"srcbadge\">\\u25C8 \\u8CC7\\u6599\\u4F86\\u6E90 <b>Bybit /v5/market</b></span>\n    </div>\n    <div class=\"bar\">\n      <span class=\"meta\" style=\"margin-left:0\">\n        \\u6383\\u63CF\\u65BC ${_t(e?.scannedAt)}\\u3000\\xB7\\u3000\\u7B26\\u5408\\u9032\\u5834\\u689D\\u4EF6 ${o} \\u6A94\n      </span>\n    </div>\n  </header>\n\n  ${u}\n\n  <div class=\"note\">\n    <strong>\\u65E9\\u671F\\u5FEB\\u5674\\u6383\\u63CF</strong>\\uFF1A\\u5728 Bybit USDT \\u7DDA\\u6027\\u6C38\\u7E8C\\u4E2D\\uFF0C\\u5C0B\\u627E\\u300C\\u5DF2\\u58D3\\u7E2E\\u3001\\u91CF\\u80FD\\u6EAB\\u548C\\u653E\\u5927\\u3001\\u672A\\u5E73\\u5009\\u91CF\\u589E\\u52A0\\u3001\\u4E14\\u5C1A\\u672A\\u7A81\\u7834\\u524D\\u9AD8\\u300D\\u7684\\u6A19\\u7684\\u3002\n    \\u5DF2\\u7D93\\u5674\\u904E\\u7684\\u4E00\\u5F8B\\u6392\\u9664\\u3002${wt({...l,scannedAt:e?.scannedAt})}\n    <div style=\"margin-top:6px;color:var(--muted)\">\n      \\u7531 Cloudflare Worker \\u6BCF ${G} \\u5206\\u9418\\u81EA\\u52D5\\u6383\\u63CF\\uFF0C${d}\\u3002\\u672C\\u9801\\u6BCF 5 \\u5206\\u9418\\u81EA\\u52D5\\u91CD\\u65B0\\u6574\\u7406\\u3002\n    </div>${f}\n  </div>\n\n  ${Nt(l)}\n${St}\n</div>\n</body>\n</html>`}var Xt={async scheduled(e,t,s){const n=t.GUARDIAN_KV;if(!n){console.log(\"\\u7F3A\\u5C11 KV \\u7D81\\u5B9A GUARDIAN_KV\\uFF0C\\u7565\\u904E\\u9019\\u4E00\\u8F2A\");return}const i=await Ne({env:t,kv:n,now:Date.now()});if(i.ok){const r=i.state.groups,a=[...r.main,...r.meme].filter(o=>o.entryReady).length;console.log(\"\\u6383\\u63CF\\u5B8C\\u6210\\uFF1A\\u5206\\u6790 \"+i.state.analyzedCount+\" \\u6A94\\uFF0C\\u53EF\\u9032\\u5834 \"+\na+\" \\u6A94\\uFF0C\\u901A\\u77E5 \"+i.notifyResult.sent+\" \\u5247\")}else console.log(\"\\u6383\\u63CF\\u5931\\u6557\\uFF1A\"+i.error)},async fetch(e,t,s){const n=t.GUARDIAN_KV;if(!n)return new Response(JSON.stringify({error:\"\\u7F3A\\u5C11 KV \\u7D81\\u5B9A GUARDIAN_KV\"},null,2),{status:500,headers:{\"content-type\":\"application/json; charset=utf-8\"}});try{return await Ot({request:e,env:t,kv:n,now:Date.now()})}catch(i){\nreturn new Response(JSON.stringify({error:String(i&&i.message?i.message:i)},null,2),{status:500,headers:{\"content-type\":\"application/json; charset=utf-8\"}})}}};export{Xt as default};\n";
